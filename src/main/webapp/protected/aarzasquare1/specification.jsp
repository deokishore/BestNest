    ...
    <nav role="navigation">
      <div class="group">
        <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-03" class="current_page_item"><span class="before dt"></span><a href="/aarzasquare1/specification.htm">Specification</a> <span class="after dt"></span></li>
    ...
    <article class="post">
        <div class="lftbox">
          <div class="rightContBox">
            <h2 class="heading_2">SPECIFICATION : AARZA SQUARE 1</h2>
            <div class="specificationblock">
              <div class="mt25">
                <a href="http://images.bestnest.in/aarza-infratech-pvt-ltd/aarza-square-1/specification-aarza-square-1.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/aarza-infratech-pvt-ltd/aarza-square-1/specification-aarza-square-1.jpg" alt="Aarza Square 1 Specification" width="600" height="600">
              		</a>
                </div>
            </div>
          </div>

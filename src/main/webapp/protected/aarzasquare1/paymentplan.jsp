...
<html>
<head>
<title>Payment Plan-Aarza Square 1 Greater Noida West Commercial Shops | BestNest Real Estate</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="Payment plan Aarza Square 1,Payment plan 2/3 BHK Apartment in Noida extension,Payment plan 2bhk flat in noida,Payment plan 2bhk flat under 25 Lacs, affordable 2/3 bhk flat,Payment plan of Property in noida,Property in noida extension, new projects in noida extension, cheapest flats in Noida extension, best residential project in Noida extension, Bestnest.in,BestNest Real Estate"/>
<meta name="description" content="Get here details about Aarza Square 1 Payment Plan.like construction payment plan, flexi payment plan, down payment plan For best deal call to our experts or fill up the enquiry form."/>
    ...
    <nav role="navigation">
      <div class="group">
        <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-06" class="current_page_item"><span class="before dt"></span><a href="/aarzasquare1/paymentPlan.htm">Payment Plan</a><span class="after dt"></span></li>
  ...
  <div role="main" class="left s-cf">
    <article class="post">
        <div class="lftbox">
            ...
            <h2 class="heading_2">PAYMENT PLAN : AARZA SQUARE 1</h2>
            <div class="specificationblock">
            <h3>Payment Plan</h3>
            </div> 
            <div class="specificationblock">
                <p>
                <a href="http://images.bestnest.in/aarza-infratech-pvt-ltd/aarza-square-1/price-list-aarza-square-1.jpg" class="fancybox">
               		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/aarza-infratech-pvt-ltd/aarza-square-1/price-list-aarza-square-1.jpg" alt="Aarza Square 1 Payment Plan" width="600" height="600">
              	</a>
                </p>
            </div>
          </div>

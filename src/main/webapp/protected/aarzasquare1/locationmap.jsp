...
<html>
<head>
<title>Location Map - Aarza Square 1 Greater Noida West Commercial Shops | BestNest Real Estate</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="Location map Aarza Square 1, 2/3 BHK Apartments, Price Starting 21 Lacs, Aarza Square 1 noida extension,BestNest Real Estate ">
<!-- End Meta Keywords for Indexing -->
<meta name="Description" content="Get here details about Aarza Square 1 Location map. you can see the Aarza Square 1 location here.also find 2/3 BHK Apartments,Price Starting 21 Lacs,Prime Location Project Free Car Parking">
    ...
    <nav role="navigation">
      <div class="group">
        <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-07" class="current_page_item"><span class="before dt"></span><a href="/aarzasquare1/locationMap.htm">Location Map</a><span class="after dt"></span></li>
  ...
  <div role="main" class="left s-cf">
    <article class="post">
    	<div class="lftbox">
            ...
            <h2 class="heading_2">LOCATION MAP : AARZA SQUARE 1</h2>
            <div class="specificationblock">
                <p>
                 <a href="http://images.bestnest.in/aarza-infratech-pvt-ltd/aarza-square-1/location-map-aarza-square-1.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/aarza-infratech-pvt-ltd/aarza-square-1/location-map-aarza-square-1.jpg" alt="Aarza Square 1 Location Map" width="600" height="600">
              		</a>
                </p>
            </div>
          </div>

...
<html>
<head>
<title>Price List-Aarza Square 1 Greater Noida West Commercial Shops | BestNest Real Estate</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="Price list Aarza Square 1,Price list 2/3 BHK Apartment in Noida extension,Price list 2bhk flat in noida,Price list 2bhk flat under 25 Lacs, affordable 2/3 bhk flat,Price list of Property in noida,Property in noida extension, new projects in noida extension, cheapest flats in Noida extension, best residential project in Noida extension, Bestnest.in,BestNest Real Estate">
<!-- End Meta Keywords for Indexing -->

<meta name="Description" content="Get here details about Aarza Square 1 price list.basic selling price, 2/3 bhk Apartment For best deal call to our experts or fill up the enquiry form.">
    ...
    <nav role="navigation">
      <div class="group">
        <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-02" class="current_page_item"><span class="before dt"></span><a href="/aarzasquare1/priceList.htm">Price List</a> <span class="after dt"></span></li>
  ...
  <div role="main" class="left s-cf">
    <article class="post">
    	<div class="lftbox">
            ...
            <h2 class="heading_2">PRICE LIST : AARZA SQUARE 1</h2>
            ...
            <div class="specificationblock">
                ...
                <a href="http://images.bestnest.in/aarza-infratech-pvt-ltd/aarza-square-1/price-list-aarza-square-1.jpg" class="fancybox">
            		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/aarza-infratech-pvt-ltd/aarza-square-1/price-list-aarza-square-1.jpg" alt="Aarza Square 1 Price List" width="600" height="600">
          		</a>
                </p>
            </div>
          </div>

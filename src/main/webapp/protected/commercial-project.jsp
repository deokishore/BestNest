...
<html>
<head>
<title>Gaur Sons | Gaur Commercial Projects in Delhi NCR | BestNest Real Estate Gaur Commercial</title>
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="upcoming commercial projects in noida, commercial projects in noida extension, commercial real estate noida, commercial projects in noida expressway, commercial property in noida extension, commercial property, commercial property in noida, commercial property for sale, commercial projects in noida" />
<meta name="description" content="The upcoming real estate projects in Noida extension by Gaursons India Limited defines the perfect blend of Luxury, Location and Style"
	...
	<div role="main" id="main">
  		<div class="sidelinks" style="left: 0px; display: block;"> <a rel="main" href="javascript:;" class="prlogo">
    		...
    		<div>
      			<ul>
                    ...
                    <li><a class="active" rel="commercial" href="/gaurproject/commercial" title="Commercial Projects">Commercial Projects</a></li>
    	...
    	<div class="middleContainer main-content clearfix">
    		<div class="rightColumnContainer discuss-right">
        		...
        		<ul>
                  <li><a href="/gaurproject/projectlisting"><img title="List View" alt="List View" src="http://images.bestnest.in/micro-site/gaursons-india-limited/list-icon.png"></a></li>
                  <li><a href="/gaurproject/projectgrid" class="active"><img title="Grid View" alt="Grid View" src="http://images.bestnest.in/micro-site/gaursons-india-limited/grid-icon.png"></a></li>
                </ul>
        <div class="clear"></div>
      </div>
                    ...
                    <div class="procontent search-results">
						<div class="clearfix search-results-list-items">
                        	<div id="profilter" class="list-container">
                            	<div id="liscont1" class="js-list-item-wrapper list-items gaur-city-plaza">
                                	<a title="Gaur City, Noida Extension" href="/projectDetail.htm?projectId=36">
                                        <div class="list-item-container">
                                            <div class="content">
                                    			<img alt="Gaur City, Noida Extension" src="http://images.bestnest.in/gaursons-india-limited/gaur-city-plaza/slide-show-1-gaur-city-plaza.jpg" itemprop="image" class="list-item-image">
                                                <div class="clearfix list-item-info">
                                                	<div class="clearfix proleft">
                                                    	<h3 itemprop="name" class="name">Gaur City Plaza</h3>
                                                        <h6 class="builder-name">Gaur Sons</h6>
                                                        <h5 class="no-of-bedrooms">191 - 992 Sq.Ft. Shops</h5>
                                                    ...
                                                    <div class="clearfix proright">
                                                        ...
                                                        <div class="bordered btn primary view-project" onClick="location.href('/projectDetail.htm?projectId=36');">
                                                        	View Project
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div id="liscont2" class="js-list-item-wrapper list-items gaur-galleria">
                                	<a title="Gaur City-2, Noida Extension" href="/projectDetail.htm?projectId=17">
                                        <div class="list-item-container">
                                            <div class="content">
                                    			<img alt="Gaur City-2, Noida Extension" src="http://images.bestnest.in/gaursons-india-limited/gaur-city-galleria/382136_original.jpg" itemprop="image" class="list-item-image">
                                                <div class="clearfix list-item-info">
                                                	<div class="clearfix proleft">
                                                    	<h3 itemprop="name" class="name">Gaur Galleria</h3>
                                                        <h6 class="builder-name">Gaur Sons</h6>
                                                        <h5 class="no-of-bedrooms"> 191 - 280 Sq.Ft. Shops</h5>
                                                        <div class="ico-location"></div>
                                                        <h5 class="locality-name">Noida Extension</h5>
                                                    </div>
                                                    <div class="clearfix proright">
                                                        ...
                                                        <div class="bordered btn primary view-project" onClick="location.href('/projectDetail.htm?projectId=17');">
                                                        	View Project
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div id="liscont3" class="js-list-item-wrapper list-items gaur-city-mall">
                                	<a title="Gaur City, Noida Extension" href="/projectDetail.htm?projectId=61">
                                        <div class="list-item-container">
                                            <div class="content">
                                    			<img alt="Gaur City-1, Noida Extension" src="http://images.bestnest.in/gaursons-india-limited/gaur-city-mall/slide-show-gaur-city-mall.jpg" itemprop="image" class="list-item-image">
                                                <div class="clearfix list-item-info">
                                                	<div class="clearfix proleft">
                                                    	<h3 itemprop="name" class="name">Gaur City Mall</h3>
                                                        <h6 class="builder-name">Gaur Sons</h6>
                                                        <h5 class="no-of-bedrooms">145-417 Sq.Ft. Office Space</h5>
                                                        <div class="ico-location"></div>
                                                        <h5 class="locality-name">Noida Extension</h5>
                                                    </div>
                                                    <div class="clearfix proright">
                                                        ...
                                                        <div class="bordered btn primary view-project" onClick="location.href('/projectDetail.htm?projectId=61');">
                                                        	View Project
                                                        </div>
                                                    </div>
                                                </div>

...
<html>
<head>
<title>Gaur Sons | Luxury Projects in Delhi NCR by| BestNest Real Estate Services </title>
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="luxury residential project, gaur sports wood, gaur saundaryam, gaur mulberry mansions, amantha" />
<meta name="description" content="gaursons provide one of the best luxury residential and commercial property in all over delhi ncr, Noida extension is maily upcoming projects hub for gaur, gaur city is one of the main township in noida extension area"
	...
	<!--Start Header Section-->
  	<header class="nav-header">
			<div class="middleContainer clearfix">
				...
				<ul class="nav">
	        	<li id="listone"><a href="/gaurproject" title="Home" class="active">Home</a> </li>
				...
				<li id="listthree" style="display:none;"><a rel="commercial" href="/gaurproject/commercial" title="Commercial Projects" class="active">Commercial Projects</a></li>
  		...
  		<div class="sidelinks" style="left: 0px; display: block;"> <a rel="main" href="javascript:;" class="prlogo">
    		...
    		<div>
      			<ul>
                    ...
                    <li><a class="active" rel="luxury" href="/gaurproject/luxury" title="Luxury Projects">Luxury Projects</a></li>
      			...
      			<div class="project-subnav">
                    ...
                    <div class="project-subnav-wrapper">
                        <ul id="portfolio" class="clearfix" data-filter-group="project-filter">
                            <li id="prolist1" class="project-filter-li item noida-ext" data-filter="gaur-saundaryam">
                            ...
                            <li id="prolist2" class="project-filter-li item noida" data-filter="gaur-sportswoods">
                            <a id="gaur-sportswoods" href="javascript:void(0);" style="background-image:url(http://images.bestnest.in/micro-site/gaursons-india-limited/project-logo/residential/gaur-sportswood.png)"></a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="procontent search-results">
						<div class="clearfix search-results-list-items">
                        	<div id="profilter" class="list-container">
                            	<div id="liscont1" class="js-list-item-wrapper list-items gaur-saundaryam">
                                	<a title="Gaur City, Noida Extension" href="/projectDetail.htm?projectId=40">
                                        <div class="list-item-container">
                                            <div class="content">
                                    			<img alt="Gaur City, Noida Extension" src="http://images.bestnest.in/gaursons-india-limited/gaur-saundaryam/slide-show-gaur-saundaryam.jpg" itemprop="image" class="list-item-image">
                                ...
                                <div id="liscont2" class="js-list-item-wrapper list-items gaur-sportswoods">
                                	<a title="Gaur City, Noida Extension" href="/projectDetail.htm?projectId=47">
                                        <div class="list-item-container">
                                            <div class="content">
                                    			<img alt="Gaur City, Noida Extension" src="http://images.bestnest.in/gaursons-india-limited/gaur-sportswood/slide-show-3-gaur-sportwood.jpg" itemprop="image" class="list-item-image">
                                                <div class="clearfix list-item-info">
                                                	<div class="clearfix proleft">
                                                        ...
                                                        <h5 class="no-of-bedrooms">3 BHK Apartment</h5>
                                                        <div class="ico-location"></div>
                                                        <h5 class="locality-name">Sector-79, Noida</h5>
                                                    </div>
                                                    <div class="clearfix proright">
                                                    	<div class="price">
                                                        	<h3 class="number">
...
<!--Responsive Navigation-->
<div style="position:fixed;top:300px;right:0;z-index:9999">

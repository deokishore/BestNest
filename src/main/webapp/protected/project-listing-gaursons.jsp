...
<html>
<head>
<title>GaurSons Projects List View | BestNest Real Estate Services </title>
	...
	<div class="outer-container">
		...
		<div role="main" id="main">
			<div class="sidelinks" style="left: 0px; display: block;">
				<a rel="main" href="/gaurproject" class="prlogo"> <img
					border="0"
					src="http://images.bestnest.in/micro-site/gaursons-india-limited/logo_gaursons.png"
					alt="Gaur Sons"></a>
				<div>
					<ul>
					...
					<div class="project-items-container">
						<div class="project_modifiers">
							<div class="listing-box fr">
								<ul>
									<li><a href="/gaurproject/projectlisting" class="active"><img alt="List View" src="http://images.bestnest.in/list-icon.png"></a></li>
									<li><a href="/gaurproject/projectgrid"><img alt="Grid View" src="http://images.bestnest.in/grid-icon.png"></a></li>
								</ul>
								<div class="clear"></div>
							</div>
...
<!--Responsive Navigation-->
	...
	<div class="righttext" style="position: fixed; top: 300px; right: 0; z-index: 9999">
		<div id="showtext" style="display: block; color: #ff0000" class="calbg">
			<div id="more">
				<div style="color: rgb(255, 255, 255);" class="calbgpd">9631500252</div>
			</div>
			<br>
		</div>
	</div>

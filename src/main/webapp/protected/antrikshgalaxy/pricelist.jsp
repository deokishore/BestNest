...
<html>
<head>
<title>Price List - Antriksh galaxy</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="Antriksh galaxy Price List, Antriksh galaxy,Price List of Antriksh galaxy DDA L Zone Dwarka">
<!-- End Meta Keywords for Indexing -->

<meta name="Description" content="Get here details about Antriksh galaxy Price List. For best deal call to our experts or fill up the enquiry form.">
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-02" class="current_page_item"><span class="before dt"></span><a href="/antrikshgalaxy/priceList.htm">Price List</a> <span class="after dt"></span></li>
...
<div id="content" class="default group" >
  ...
  <article class="post">
    	<div class="lftbox">
            ...
            <h2 class="heading_2">PRICE LIST : ANTRIKSH GALAXY</h2>
            <div class="specificationblock">
               <h3>Price List & Payment Plan</h3>
            </div>
            <div class="specificationblock">
                <p>
                <a href="http://images.bestnest.in/antriksh-group/antriksh-galaxy/price-list-antriksh-galaxy.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/antriksh-group/antriksh-galaxy/price-list-antriksh-galaxy.jpg" alt="Antriksh Galaxy Price List" width="500" height="500">
              		</a>
                </p>
            </div>
          </div>

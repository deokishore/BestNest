...
<html>
<head>
<title>Location Map - Antriksh Galaxy</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="Antriksh Galaxy Location Map, Antriksh Galaxy, Location Map of Antriksh Galaxy DDA L Zone Dwarka">
<!-- End Meta Keywords for Indexing -->
<meta name="Description" content="Get here details about Antriksh Galaxy Location Map. For best deal call to our experts or fill up the enquiry form.">
  ...
  <div role="main" class="left s-cf">
    <article class="post">
    	<div class="lftbox">
            ...
            <h2 class="heading_2">LOCATION MAP : ANTRIKSH GALAXY</h2>
            <div class="specificationblock">
                <p>
                	<a href="http://images.bestnest.in/antriksh-group/antriksh-galaxy/location-map-antriksh-galaxy.jpg" class="fancybox"><img class="layout-imgs propertyImg" src="http://images.bestnest.in/antriksh-group/antriksh-galaxy/location-map-antriksh-galaxy.jpg" alt="Antriksh Galaxy Location Map" width="500" height="500"></a>
                </p>
            </div>
          </div>
        </div>

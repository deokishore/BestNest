...
<html>
<head>
<title>Site Plan - Antriksh Galaxy</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="Antriksh Galaxy Site Plan, Antriksh Galaxy,Site Plan of Antriksh Galaxy DDA L Zone">
<!-- End Meta Keywords for Indexing -->
<meta name="Description" content="Get here details about Antriksh Galaxy site plan. For best deal call to our experts or fill up the enquiry form.">
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-05" class="current_page_item"><span class="before dt"></span><a href="/antrikshgalaxy/sitePlan.htm">Site Plan</a><span class="after dt"></span></li>
   ...
   <article class="post">
        <div class="lftbox">
          <div class="rightContBox">
            <h2 class="heading_2">SITE PLAN : ANTRIKSH GALAXY</h2>
            <div class="specificationblock">
                <p>
                <a href="http://images.bestnest.in/antriksh-group/antriksh-galaxy/site-plan-antriksh-galaxy.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/antriksh-group/antriksh-galaxy/site-plan-antriksh-galaxy.jpg" alt="Antriksh Galaxy Site Plan" width="500" height="500">
              		</a>
                </p>
            </div>
          </div>

...
<html>
<head>
<title>Payment Plan - Antriksh Galaxy</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="Antriksh galaxy Payment Plan, Antriksh galaxy,Payment Plan of Antriksh galaxy Delhi Dwarka"/>
<meta name="description" content="Get here details about Antriksh galaxy Payment Plan. For best deal call to our experts or fill up the enquiry form."/>
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-06" class="current_page_item"><span class="before dt"></span><a href="/antrikshgalaxy/paymentPlan.htm">Payment Plan</a><span class="after dt"></span></li>
  ...
  <div role="main" class="left s-cf">
   <article class="post">
        <div class="lftbox">
            ...
            <h2 class="heading_2">PAYMENT PLAN : ANTRIKSH GALAXY</h2>
            <div class="specificationblock">
            <h3> Payment Plan </h3>
            </div> 
            <div class="specificationblock">
                <p>
                <a href="http://images.bestnest.in/antriksh-group/antriksh-galaxy/price-list-antriksh-galaxy.jpg" class="fancybox"><img class="layout-imgs propertyImg" src="http://images.bestnest.in/antriksh-group/antriksh-galaxy/price-list-antriksh-galaxy.jpg" alt="Antriksh Galaxy Price List" width="500" height="500">
              		</a> 
                </p>
            </div>
          </div>

...
<html>
<head>
<title>Mahagun India| Luxury Projects in Noida Extension by| BestNest Real Estate Services </title>
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="Luxury Projects by Mahagun, Noida Extension Luxury Projects, Noida luxury project,most luxury projects in Central noida by mahagun,most luxury projects in noida Extension by Mahagun" />
<!-- End Meta Keywords for Indexing -->
<meta name="description" content="Mahagun provide Most luxury projects in noida and at Affordable Price Where You Can Feel Like Haven and Be relaxed."/>
...
<div class="outer-container"> 
	...
	<div role="main" id="main">
  		<div class="sidelinks" style="left: 0px; display: block;"> <a rel="main" href="javascript:;" class="prlogo">
    		...
    		<div>
      			<ul>
                    <li><a rel="residential" href="/mahagunproject/residential" title="Residential Projects">Residential Projects</a></li>
    	...
    	<div class="middleContainer main-content clearfix">
    		<div class="rightColumnContainer discuss-right">
      			<h1 id="toptitle">Luxury Projects</h1>
      			...
      			<div class="project-subnav">
                    ...
                    <div class="project-subnav-wrapper">
                        <ul id="portfolio" class="clearfix">
                            <li id="prolist1" class="project-filter-li item noida" data-filter="mahagun-mezzaria">
                            <a id="mahagun-mezzaria" href="javascript:void(0);" style="background-image:url(http://images.bestnest.in/micro-site/mahagun-group/project-logo/residential/mahagun-mezzaria.png)"></a>
                            </li>
                            <li id="prolist2" class="project-filter-li item noida" data-filter="mahagun-mirabella">
                            <a id="mahagun-mirabella" href="javascript:void(0);" style="background-image:url(http://images.bestnest.in/micro-site/mahagun-group/project-logo/residential/mahagun-mirabella.png)"></a>
                            </li>
                            <li id="prolist3" class="project-filter-li item noida" data-filter="mahagun-moderne">
                            <a id="mahagun-moderne" href="javascript:void(0);" style="background-image:url(http://images.bestnest.in/micro-site/mahagun-group/project-logo/residential/mahagun-moderne.png)"></a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="procontent search-results">
						<div class="clearfix search-results-list-items">
                        	<div id="profilter" class="list-container">
                                ...
                                <div id="liscont1" class="js-list-item-wrapper list-items mahagun-mezzaria">
                                ...
                                <div id="liscont2" class="js-list-item-wrapper list-items mahagun-mirabella">
                                ...
                                <div id="liscont3" class="js-list-item-wrapper list-items mahagun-moderne">

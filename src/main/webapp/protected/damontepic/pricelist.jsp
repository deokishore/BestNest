...
<html>
<head>
<title>Price List-Damont Epic | 2,3 BHK Apartments | BestNest Real Estate</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="damont epic price list,damont group projects,damont noida extension,damont epic residential project payment plan,damont epic noida extension, 2/3 bhk aparments price list,price list of 2/3 bhk at affordbale price,damont epic greater noida west, BestNest Real Estate, bestnest.in">
<!-- End Meta Keywords for Indexing -->

<meta name="Description" content="Get here details about damont epic price list. For best deal call to our experts or fill up the enquiry form.">
  ...
  <div role="main" class="left s-cf">
    <article class="post">
    	<div class="lftbox">
            ...
            <h2 class="heading_2">PRICE LIST : DAMONT EPIC</h2>
            ...
            <div class="specificationblock">
                ...
                <a href="http://images.bestnest.in/damont-group/damont-epic/price-list-damont-epic.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/damont-group/damont-epic/price-list-damont-epic.jpg" alt="Damont Epic Price List" width="600" height="600">
              		</a>
                </p>
            </div>
          </div>

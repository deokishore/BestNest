...
<html>
<head>
<title>Location Map-Damont Epic | 2,3 BHK Apartments | BestNest Real Estate</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="damont epic location map,damont group projects,damont noida extension,damont epic residential project location map,damont epic noida extension, 2/3 bhk aparments location map in sector 12 noida extension,Contact for 2/3 bhk at affordbale price,Contact damont epic greater noida west, BestNest Real Estate, bestnest.in">
<!-- End Meta Keywords for Indexing -->
<meta name="Description" content="Get here details about damont Location Map. For best deal call to our experts or fill up the enquiry form.">
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-07" class="current_page_item"><span class="before dt"></span><a href="/damontepic/locationMap.htm">Location Map</a><span class="after dt"></span></li>
  ...
  <div role="main" class="left s-cf">
    <article class="post">
    	<div class="lftbox">
            ...
            <h2 class="heading_2">LOCATION MAP : DAMONT EPIC</h2>
            <div class="specificationblock">
                <p>
                 <a href="http://images.bestnest.in/damont-group/damont-epic/location-map-damont-epic.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/damont-group/damont-epic/location-map-damont-epic.jpg" alt="Damont Epic Location Map" width="600" height="600">
              		</a>
                </p>
            </div>
          </div>

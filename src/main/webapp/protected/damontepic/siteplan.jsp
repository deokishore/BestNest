...
<html>
<head>
<title>Site Plan-Damont Epic | 2,3 BHK Apartments | BestNest Real Estate</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="damont epic site plan,damont group projects,damont noida extension,damont epic residential project site plan,damont epic noida extension, 2/3 bhk aparments site plan,site plan of 2/3 bhk at affordbale price,damont epic greater noida west, BestNest Real Estate, bestnest.in">
<!-- End Meta Keywords for Indexing -->
<meta name="Description" content="Get here details about damont epic site plan. For best deal call to our experts or fill up the enquiry form.">
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-05" class="current_page_item"><span class="before dt"></span><a href="/damontepic/sitePlan.htm">Site Plan</a><span class="after dt"></span></li>
    ...
    <article class="post">
        <div class="lftbox">
          <div class="rightContBox">
            <h2 class="heading_2">SITE PLAN : DAMONT EPIC</h2>
            <div class="specificationblock">
                <p>
                <a href="http://images.bestnest.in/damont-group/damont-epic/site-plan-damont-epic.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/damont-group/damont-epic/site-plan-damont-epic.jpg" alt="Damont Epic Site Plan" width="600" height="600">
              		</a>

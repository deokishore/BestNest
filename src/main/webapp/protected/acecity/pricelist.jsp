...
<html>
<head>
<title>Price List - Ace City | 2,3 BHK Apartments | Noida Extension | BestNest Real Estate</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="ace city price list,ace group projects,ace noida extension,ace city residential project payment plan,ace city noida extension, 2/3 bhk aparments price list, price list of 2/3 bhk at affordbale price,ace city price list greater noida west, BestNest Real Estate, bestnest.in">
<!-- End Meta Keywords for Indexing -->

<meta name="Description" content="Get here details about ace city price list. For best deal call to our experts or fill up the enquiry form.">
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-02" class="current_page_item"><span class="before dt"></span><a href="/acecity/priceList.htm">Price List</a> <span class="after dt"></span></li>
  ...
  <div role="main" class="left s-cf">
   <article class="post">
    	<div class="lftbox">
            ...
            <h2 class="heading_2">PRICE LIST : ACE CITY</h2>
            ...
            <div class="specificationblock">
                ...
                <a href="http://images.bestnest.in/ace-group/ace-city/price-list-ace-city.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/ace-group/ace-city/price-list-ace-city.jpg" alt="Ace City Price List" width="600" height="600">
              		</a>
                </p>
            </div>
          </div>

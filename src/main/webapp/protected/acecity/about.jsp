...
<html>
<head>
<title>About - Ace City | Noida Extension | 2,3 BHK Apartments | BestNest Real Estate</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="About ace city, about Ace group projects, about ace noida extension,ace city noida extension, 2/3 bhk aparments in sector 1 noida extension,about 2/3 bhk at affordbale price,About ace city greater noida west,BestNest Real Estate, bestnest.in" />
<meta name="description" content="ACE City is a residential project, which provides 2, 3 BHK apartments. The advantages of getting property here are that it is closer to Express Highway, near to Delhi, metro connectivity, wider roads, appropriate underground cabling, excellent drainage system, reputed Institutional area and excellent connectivity from South and East Delhi." />
...
<div id="outer-container"> 
    ...
    <div class="container group">
      ...
      <div class="top-menu dt">
        <ul class="menu" id="menu-top-menu">
          <li id="top-menu-item-01" class="selected"><a href="/acecity/about.htm">About</a></li>
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-08" class="current_page_item s alt"><span class="before dt"></span><a href="/acecity/about.htm">About</a><span class="after dt"></span></li>
 ...
 <div role="main" class="left s-cf">
      <article class="post">
        ...
        <h2 class="heading_2">ABOUT : ACE CITY</h2>
        <div class="specificationblock">
             <p class="paddingtopbot10 text">ACE City is a residential project, which provides 2, 3 BHK apartments. The advantages of getting property here are that it is closer to Express Highway, near to Delhi, metro connectivity, wider roads, appropriate underground cabling, excellent drainage system, reputed Institutional area and excellent connectivity from South and East Delhi. Buying residence here is a good option of investment and attracts the client's interest with its ambience.</p>
             
             <p class="paddingtopbot10 text">ACE City provides you with both external and internal amenities like power back up, lift, intercom facility, gym, 24 hours water supply, security, infrastructure, reserved parking, parks and open spaces. Being one of the posh localities of Greater Noida West, we create a cosmopolitan residence and have become the center of activity or interest in the clients' eyes. It provides spaciously premium, sophisticated and interesting choice of residence to live in. </p>
...
<p class="paddingtopbot10 text">The perfect choice if you are a true connoisseur of art and elegance. Spacious homes that give your life ample room to grow and nurture it with the facilities those are inclusive of the best of concierge services. Here is what we offer : </p>
        ...
        <div id="specification">  
        	<ul>
              <li>Walking distance from Balak Inter College</li>
              <li>8 kms. from Noida City Centre Metro Station</li>
              <li>7 kms. from Sai Mandir</li>
              <li>8 kms. from Fortis Hospital</li>
              <li>13 kms. from kalindi kunj</li>
              <li> 15 mins. drive from Sector 18</li>
        </ul>
        </div>
      </div>
        </div>

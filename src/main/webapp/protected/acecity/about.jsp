    ...
    <div class="container group">
      ...
      <div class="top-menu dt">
        <ul class="menu" id="menu-top-menu">
          <li id="top-menu-item-01" class="selected"><a href="/acecity/about">About</a></li>
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-08" class="current_page_item s alt"><span class="before dt"></span><a href="/acecity/about">About</a><span class="after dt"></span></li>

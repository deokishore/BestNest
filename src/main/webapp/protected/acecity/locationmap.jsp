...
<html>
<head>
<title>Location Map - Ace City | 2,3 BHK Apartments | Noida Extension | BestNest Real Estate</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="ace city location map,ace group projects,ace noida extension,ace city residential project location map,ace city noida extension, 2/3 bhk aparments location map in sector 1 noida extension,Contact for 2/3 bhk at affordbale price,Contact ace city greater noida west,2/3 BHK Apartments,Price Starting 36 Lacs Onwards,Prime Location Project Free Covered Car Parking BestNest Real Estate, bestnest.in">
<!-- End Meta Keywords for Indexing -->
<meta name="Description" content="Get here details about ace city Location Map. For best deal call to our experts or fill up the enquiry form.">
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-07" class="current_page_item"><span class="before dt"></span><a href="/acecity/locationMap.htm">Location Map</a><span class="after dt"></span></li>
  ...
  <div role="main" class="left s-cf">
    <article class="post">
    	<div class="lftbox">
            ...
            <h2 class="heading_2">LOCATION MAP : ACE CITY</h2>
            <div class="specificationblock">
                <p>
                 <a href="http://images.bestnest.in/ace-group/ace-city/location-map-ace-city.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/ace-group/ace-city/location-map-ace-city.jpg" alt="Ace City Location Map" width="600" height="600">
              		</a>
                </p>
            </div>
          </div>

...
<html>
<head>
<title>Site Plan - Ace City | 2,3 BHK Apartments | Noida Extension | BestNest Real Estate</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="ace city site plan, ace group projects, ace noida extension, ace city residential project site plan, ace city noida extension, 2/3 bhk aparments site plan, site plan of 2/3 bhk flat at lowest rate, ace city greater noida west, BestNest Real Estate, bestnest.in">
<!-- End Meta Keywords for Indexing -->
<meta name="Description" content="Get here details about ace city site plan. For best deal call to our experts or fill up the enquiry form.">
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-05" class="current_page_item"><span class="before dt"></span><a href="/acecity/sitePlan.htm">Site Plan</a><span class="after dt"></span></li>
    ...
    <article class="post">
        <div class="lftbox">
          <div class="rightContBox">
            <h2 class="heading_2">SITE PLAN : ACE CITY</h2>
            <div class="specificationblock">
                <p>
                <a href="http://images.bestnest.in/ace-group/ace-city/site-plan-ace-city.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/ace-group/ace-city/site-plan-ace-city.jpg" alt="Ace City Site Plan" width="600" height="600">
              		</a>

...
<html>
<head>
<title>Specification - Ace City | 2,3 BHK Apartments | Noida Extension | BestNest Real Estate</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="ace city specification,ace group projects,ace noida extension,ace city residential project specification,ace city noida extension, 2/3 bhk aparments specification, specification of 2/3 bhk at affordbale price,ace city greater noida west, Ace city specification, BestNest Real Estate, bestnest.in"/>
<!-- End Meta Keywords for Indexing -->
<meta name="description" content="Get here details information about ace city Specification.like electricals,security,doors & windows,Club,flooring,fire fighting, For best deal call to our experts or fill up the enquiry form."/>
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-03" class="current_page_item"><span class="before dt"></span><a href="/acecity/specification.htm">Specification</a> <span class="after dt"></span></li>
     ...
     <article class="post">
        <div class="lftbox">
          <div class="rightContBox">
            <h2 class="heading_2">SPECIFICATION : ACE CITY</h2>
            <div class="specificationblock">
              <p><a href="http://images.bestnest.in/ace-group/ace-city/specification-ace-city.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/ace-group/ace-city/specification-ace-city.jpg" alt="Ace City Specification" width="600" height="600">
              		</a></p>
            </div>
          </div>
        </div>

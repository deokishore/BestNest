...
<html>
<head>
<title>Contact Us - Ace City | 2,3 BHK Apartments | Noida Extension | BestNest Real Estate</title>
...
<meta name="description" content="Contact us as BESTNEST REAL ESTATE SERVICES PVT. LTD. D-77, Ground Floor, Sector 63,Noida Call Us: +91-9631500252, 91 , query@bestnest.in."/>
    ...
    <div class="container group">
      ...
      <div class="top-menu dt">
        <ul class="menu" id="menu-top-menu">
          ...
          <li id="top-menu-item-02" class="selected"><a href="/acecity/contact.htm">Contact Us</a></li>
        </ul>
      </div>
    ...
    <nav role="navigation">
      <div class="group">
       <ul class="menu" id="menu-main-menu">
          ...
          <li id="main-menu-09" class="current_page_item s alt"><span class="before dt"></span><a href="/acecity/contact.htm">Contact Us</a><span class="after dt"></span></li>

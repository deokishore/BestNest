...
<html><head>
<meta charset="utf-8">
<title>User Registration | NRI Services | BestNest Real Estate NRI Services</title>
<meta name="keywords" content="NRI Plot Management,NRI Construction Updates,NRI Tenant management, NRI Services in India,NRI Services in Delhi/NCR." />
<meta name="description" content="BestNest Provide NRI Services to client, for Plot Management,Construction Updates,Tenant Management from any where in the world"/>
...
<header>
  <div class="head">
    <div class="logo"> 
    	<a href="index.html">
        	<img src="http://images.bestnest.in/best-nest.png" alt="BestNest Real Estate Service Pvt. Ltd." />
        </a>
     	<div class="clear"></div>
    </div>
    	...
    	<!--NRI Box Section-->
        	<div class="nri-content">
                <div class="nrservice-wrapper">
                	<div class="themeFont" style="font-size:14px; border-bottom: 2px solid #3274ae; 
                    padding-bottom:5px;">User Registration</div>
                    <div class="services-wrap marginT15">
                    	<h2><span>User Sign-in</span></h2>
                        <div class="userContainerText">
                        	<div id="textViewLeft" class="textViewLeft">
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:10px; font-family:Arial;">
                            	<tbody>
                                	<tr>
                                       <td width="45%" style="padding-left:10px;padding-bottom:10px">
                                            	<label class="themeFont">Existing User Login</label>
                                            </td>
                                       <td width="2" align="center" style="height: 100%; background-color:                                            #EFEFEF">
  											</td>
                                       <td style="padding-left:10px;padding-bottom:10px">
												<label class="themeFont">New User?</label>
                                       </td>
                                    </tr>
                                    <tr>
                                        <td style="padding-left:10px">
                                            <form action="/login.do" method="post" name="form1" id="form1">
                                                <table class="reg-form1" cellspacing="3" cellpadding="0" border="0" style="padding-right: 5px">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <label class="themeFont">Email/Login</label>
                                                            </td>
                                                            <td align="left" class="emailInput" colspan="2">
                                                                <input type="text" value="" id="email" name="email" maxlength="30">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <label class="themeFont">Password</label>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td valign="middle">
                                                            <div id="errorDiv" style="width: 220px; height: 15px"
                                                            align="right">
                                                                <span id="error" class="error" style="font-size: 10px">
                                                                </span>
                                                            </div>
                                                            </td>
                                                            <td align="right">
                            <button type="submit" name="ilogin"	id="ilogin" class="btn b yellow marginL5 marginT10" value="Login">                                 	<span>Login</span>
                            </button>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <td width="2" align="center" style="height: 100%; background-color: #EFEFEF"></td>
                                        <td style="padding-left:10px;text-align:top;">
                                            <table cellspacing="0" cellpadding="3" border="0">
                                                <tbody>
                                                    <tr>
                                                        <td style="text-align:top">
                                                            <label class="themeFont">Sign up for                                                                    NRIServicesOnline Account and Continue!
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="right">
                                                <form id="form2" name="form2" method="get" action="user-registration.html">
                        <input type="hidden" value="intake" id="from" name="from" /> 
                <button type="submit" class="btn b yellow marginL5" value="Register Now"><span>Register Now</span></button>
                                                </form>
                                                        </td>
                                                    </tr>
                                                </tbody>

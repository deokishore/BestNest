...
<html>
<head>
<title>Mahagun India| Commercial Property in Noida | BestNest Real Estate Services  </title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="Noida Extension Commercial Projects, property in noida extension, Shops in noida extension,Office Space in noida extension,Commercial Property in Noida extension, Mahagun group in noida extension  " />
<!-- End Meta Keywords for Indexing -->
<meta name="description" content="Mahagunindia provide one of the best  projects in delhi ncr, One of the best Commercial projects in Noida extension belongs to mahagunindia, Mahagun group provides all modern and luxurious facilities." />
...
<div class="outer-container"> 
  	...
  	<header class="nav-header">
			<div class="middleContainer clearfix">
				...
				<ul class="nav">
					...
					<li id="listthree" style="display:none;"><a rel="commercial" href="/mahagunproject/commercial" title="Commercial Projects"  class="active">Commercial Projects</a></li>
	...
	<div role="main" id="main">
  		<div class="sidelinks" style="left: 0px; display: block;"> <a rel="main" href="javascript:;" class="prlogo">
    		...
    		<div>
      			<ul>
                    <li><a rel="residential" href="/mahagunproject/residentialproject.htm" title="Residential Projects">Residential Projects</a></li>
                    <li><a class="active" rel="commercial" href="/mahagunproject/commercialproject.htm" title="Commercial Projects">Commercial Projects</a></li>
                    <li><a rel="aboutus" href="/mahagunproject/aboutus.htm" title="About Us">About Mahagun</a></li>
                    <li><a rel="contact" href="/mahagunproject/contactus.htm" title="Contact Us">Contact Us</a></li>
                	<div class="clear"></div>
              	</ul>
    		</div>
  		</div>
      			...
      			<div class="project-subnav">
                    ...
                    <div class="project-subnav-wrapper">
                        <ul id="portfolio" class="clearfix">
                            <li id="prolist1" class="project-filter-li item noida-ext" data-filter="mahagun-mywoods-mart">
                            <a id="mahagun-mywoods-mart" href="javascript:void(0);" style="background-image:url(http://images.bestnest.in/micro-site/mahagun-group/project-logo/commercial/mahagun-mywoods-mart.png)"></a>
                            </li>      
                        </ul>
                    </div>
                    ...
                    <div class="procontent search-results">
						<div class="clearfix search-results-list-items">
                        	<div id="profilter" class="list-container">
                            	<div id="liscont1" class="js-list-item-wrapper list-items mahagun-mywoods-mart">
                                	<a title="Mahagun Mywoods Mart, Noida Extension" href="/projectDetail.htm?projectId=71">
                                        <div class="list-item-container">
                                            <div class="content">
                                    			<img alt="Mahagun Group , Noida Extension" src="http://images.bestnest.in/mahagun-group/mahagun-mywoods-mart/slide-show-mahagun-mywoods-mart.jpg" itemprop="image" class="list-item-image">
                                                <div class="clearfix list-item-info">
                                                	<div class="clearfix proleft">
                                                    	<h3 itemprop="name" class="name">Mahagun Mywoods Mart</h3>
                                                        <h6 class="builder-name">Mahagun Group</h6>
                                                        <h5 class="no-of-bedrooms">324 - 420 sq ft Shops</h5>
                                                    ...
                                                    <div class="clearfix proright">
                                                        ...
                                                        <div class="bordered btn primary view-project" onClick="location.href('/projectDetail.htm?projectId=71');">
                                                        	View Project
                                                        </div>
                                                    </div>
                                                </div>

...
<html>
<head>
<title>Gaur Sons | About Gaur Projects in Delhi NCR | BestNest Real Estate </title>
...
<meta name="description" content="Gaursons stress on customer's trust has become the winning mantra. A fact our customers would vouch for."
...
<div class="outer-container"> 
  	...
  	<header class="nav-header">
			<div class="middleContainer clearfix">
				...
				<ul class="nav">
			        ...
			        <li id="listfour"><a href="/gaurproject/aboutUsGaursons" title="About Us" class="active">About Gaur</a> </li>
	...
	<a href="javascript:void(0);"><img
				src="http://images.bestnest.in/micro-site/gaursons-india-limited/slideimages/slideimage1.jpg"
				width="1583" height="450" alt="Image1" /> </a> <a
				href="javascript:void(0);"><img
				src="http://images.bestnest.in/micro-site/gaursons-india-limited/slideimages/slideimage2.jpg"
				width="1583" height="450" alt="Image2" /> </a> <a
				href="javascript:void(0);"><img
				src="http://images.bestnest.in/micro-site/gaursons-india-limited/slideimages/slideimage3.jpg"
				width="1583" height="450" alt="Image3" /> </a> <a
				href="javascript:void(0);"><img
				src="http://images.bestnest.in/micro-site/gaursons-india-limited/slideimages/slideimage4.jpg"
				width="1583" height="450" alt="Image4" /> </a> <a
				href="javascript:void(0);"><img
				src="http://images.bestnest.in/micro-site/gaursons-india-limited/slideimages/slideimage5.jpg"
				width="1583" height="450" alt="Image5" /> </a>
</div>
	<!--End Slideshow Area--> 
	<!--Start Main Content Section-->
	<div role="main" id="main">
  		<div class="sidelinks" style="left: 0px; display: block; top:195px;"> <a rel="main" href="javascript:;" class="prlogo">
    		...
    		<div>
      			<ul>
                    <li><a rel="residential" href="/gaurproject/residential" title="Residential Projects">Residential Projects</a></li>
						...
						<li><a class="active"  rel="aboutus" href="/gaurproject/aboutUsGaursons" title="About Us">About	Gaur</a></li>
 	 	...
 	 	<div class="middleContainer clearfix">
    		<div class="rightColumnContainer">
                ...
                <div class="rows clearfix">
                	<h2>'Think Trust. Think GAURSONS.'</h2>
                    <p>Gaursons India Limited needs no introduction in the world of brick and mortar. The company has significant presence in the NCR region with various projects successfully completed and delivered. </p>
                    <p>Founded in the year 1995, Gaursons India Limited has never looked back. With a credo of chasing excellence in each and every      endeavour, Gaursons, since its inception, has been riding high on the path of success. Since the very beginning, the company is on a journey of architectural excellence and customer satisfaction with a clear vision - to not only create innovative architecture but transform real estate vision into reality. With a long list of residential projects in Delhi NCR, it is one of the leading builders active in the region today. This multi-interest, multi-utility, real estate company is determined to create new architectural marvels in the future. </p>
                    <p>Gaursons India Limited stands for "The synonym of trust in realty", a fact that thousands of its customers would vouch for. With a proud history of delivering projects on time and as per promised specifications, Gaursons is a name to reckon with when it comes to real estate in NCR. With a burgeoning list of residential projects, Gaursons has been involved in providing living spaces ranging from high end apartments to highly affordable accommodations to thousands of families today. The company has been incessantly delivering projects on time and with committed specifications along with stressing on the customer's trust which has become the winning mantra for Gaursons. </p>
                    <p>With its projects Gaur city 1, Gaur Gaur City2, Gaur Atulyam, Gaur Sports Wood, Gaur Cross Republic, Gaur Homes Elegante, Gaur Grandeur and Gaur Gracious, Gaursons has left no stone unturned in giving the best deals to its buyers. The company's latest projects Gaur Mulberry Mansions and Gaur Saundaryam in Noida Extension is the latest in luxury living. </p>
                    <p>In 2013, Gaursons entered into the retail business with the launch of 'Gaur Central Mall' at RDC, Ghaziabad is an extraordinary mall blending International standard with the effervescence of modern life. </p>
                </div>
			</div>
     	</div>
  	</div>

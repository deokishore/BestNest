  	...
  	<header class="nav-header">
			<div class="middleContainer clearfix">
				...
				<ul class="nav">
			        ...
			        <li id="listfour"><a href="/gaurproject/aboutus" title="About Us" class="active">About Gaur</a> </li>
    		...
    		<div>
      			<ul>
                    <li><a rel="residential" href="/gaurproject/residential" title="Residential Projects">Residential Projects</a></li>
						...
						<li><a class="active"  rel="aboutus" href="/gaurproject/aboutus" title="About Us">About	Gaur</a></li>

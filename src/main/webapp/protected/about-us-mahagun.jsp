...
<html>
<head>
<title>About Us, Mahagun Group, Mahagun India | BestNest Real Estate </title>
<meta name="keywords" content="About Mahagun India,About  Mahagun Noida Extension, About Mahagun Noida, Mahagun Central Noida, Mahagun Noida Expressway, Mahagun Group, Mahagun Builder, Mahagun Projects In Noida Extension" />
<meta name="description" content="Mahagun group is a brand in real estate industry, he has delivered lots of projects in Delhi NCR, But Noida and Noida Extension area's projects is Most affordable and Quality projects by mahagunindia." />
  	...
  	<header class="nav-header">
			<div class="middleContainer clearfix">
				...
				<ul class="nav">
			        ...
			        <li id="listfour"><a href="/mahagunproject/aboutus" title="About Us" class="active">About Mahagun</a> </li>
	...
	<div role="main" id="main">
  		<div class="sidelinks" style="left: 0px; display: block;"> <a rel="main" href="javascript:;" class="prlogo">
    		...
    		<div>
      			<ul>
                    ...
                    <li><a class="active" rel="aboutus" href="/mahagunproject/aboutus" title="About Us">About Mahagun</a></li>
 	 	...
 	 	<div class="middleContainer clearfix">
    		<div class="rightColumnContainer">
				<h1 id="toptitle">About Us</h1>
                <div class="rows clearfix">
                	<h2>MAHAGUN A NAME THAT PERFORMS</h2>
                    <p>Mahagun group is a conglomerate of companies operating in real estate, commercial and hospitality sectors. It is an organization of zealous engineers and space planners, rich in experience and high on commitment, that have helped the group to sustain professional excellence for more than 4 decades. </p>
                    <p>The group is founded on the motto to usher a better tomorrow by providing people with improved quality of life and living standards. It has already delivered approx.7.00 million sq.ft of residential space covering about 4000 units and projects involving development of approx.18.50 million sq.ft covering about 15000 units are currently under execution. </p>
                    <p>Mahagun has been relentlessly pursuing the principle “We Deliver What We Commit” and the outstanding success of the group can be attributed to the same. The group takes great pride in the fact that it has completed and handed over its projects well before its stipulated time. Today through its sincerity, dedication and absolute commitment, the company is synonymous with complete transparency in all its operations coupled with timely delivery , ensuring adherence to all statutory regulations and guidelines. </p>
                    <p>Guided by absolute commitment, customer focus, innovation and professional expertise gained over the years, Mahagun endeavors to emerge as one of the key players in real estate construction and development in India.We strive to provide value for money to customer, by timely delivery of quality product at reasonable prices, through transparent and ethical policies and procedures,as a part of our commitment to the national mission of providing homes to millions of people. </p>
                    
                    <p>Mahagun as a group believes that no organization in the modern world can survive unless it is responsive to the changing environment in terms of technology, customer perceptions, optimum utilization of resources and a host of other factors. Following the aforesaid belief, the company has to its credit awards for pioneering new trends in the market </p>
                </div>
			</div>
     	</div>
  	</div>

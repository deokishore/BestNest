...
<html>
<head>
<title>Gulshan botnia Sector 144 noida payment plan </title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="Payment plan Gulshan botnia Sector 144 noida expressway,Payment plan 2/3/4 BHK Apartment in noida expressway, Payment plan 2/3/4 BHK flat in noida expressway, affordable flat in noida expressway,Payment plan of Property in noida sector 144,Property in noida expressway, new projects in noida expressway, cheapest flats in noida expressway, best residential project in Sector 144 noida, bestnest.in, BestNest Real Estate"/>
<meta name="description" content="payment to be made to builder in different format like flexi plan, clp plan, subvention plan."/>
...
<header role="banner" id="header">
  <div class="container group">
      <div class="logo left s-cf"> <a title="Buy 2/3 BHK Apartments - Gulshan botnia Noida expressway" href="http://images.bestnest.in/gushan-homz/gulshan-bitnia/gulshan-botnia-logo.png"></a></div>
      <div class="txtleft">
  ...
  <div role="main" class="left s-cf">
    <article class="post">
        <div class="lftbox">
            ...
            <h2 class="heading_2">PAYMENT PLAN : GULSHAN BOTNIA, SECTOR 144 NOIDA</h2>
            <div class="specificationblock">
            <h3>Payment Plan</h3>
            </div> 
            <div class="specificationblock">
                <p>
                <a href="http://images.bestnest.in/gushan-homz/gulshan-bitnia/payment-plan-gulshan-botnia.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/gushan-homz/gulshan-botnia/payment-plan-gulshan-botnia.jpg" alt="Gulshan Botnia Sector 144 Noida Payment Plan" width="600" height="600">
              		</a>
                </p>
            </div>
          </div>

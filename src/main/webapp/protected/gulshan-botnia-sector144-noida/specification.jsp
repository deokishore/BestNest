...
<html>
<head>
<title>Gulshan Botnia Specification Noida Sector 144  </title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<!-- Meta Keywords for Indexing -->
<meta name="keywords" content="specification Gulshan Botnia Noida,specification 2/3 BHK Apartment in Gulshan botnia ,specification 2bhk flat in Gulshan botnia, affordable 2/3 bhk flat, specification of Property in Sector 144 Noida,Property in Sector 144 Noida, new projects in Noida expressway by gulshan botnia, cheapest flats in Sector 144 Noida, best residential project in Noida expressway, www.Bestnest.in, BestNest Real Estate"/>
<!-- End Meta Keywords for Indexing -->
<meta name="description" content="find the details information about Gulshan botnia new project Specification, like Structure,Layout,Doors & windows,hardware,kitchen,toilet,Security, internal finish,light, Electrical, For best deal call to our Sales experts."/>
...
<header role="banner" id="header">
  <div class="container group">
      <div class="logo left s-cf"> <a title="Buy 2/3/4 BHK Apartments - gulshan homz sector144 noida" href="http://images.bestnest.in/gushan-homz/gulshan-botnia/gulshan-botnia-logo.png"></a></div>
      <div class="txtleft">
    ...
    <article class="post">
        <div class="lftbox">
          <div class="rightContBox">
            <h2 class="heading_2">SPECIFICATION : GULSHAN BOTNIA, SECTOR 144 NOIDA</h2>
            <div class="specificationblock">
              <p>GULSHAN HOMZ : SPECIFICATION FLOORING
Vitrified tiles in drawing, dining, kitchen & entrance lobby
Vitrified tiles in all bedrooms
Ceramic tiles in toilets and balconies.</p>
              <div class="mt25">
                <a href="http://images.bestnest.in/gushan-homz/gulshan-botnia/specification-gulshan-botnia.jpg" class="fancybox">
                		<img class="layout-imgs propertyImg" src="http://images.bestnest.in/gushan-homz/gulshan-botnia/specification-gulshan-botnia.jpg" alt="Gulshan Homz Sector 144 Noida  Specification" width="600" height="600">
              		</a>
                </div>
            </div>
          </div>

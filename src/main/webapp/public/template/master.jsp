...
<!-- BestNest Homepage.Js File -->
<script src="http://resources.bestnest.in/js/home-page.js" type="text/javascript"></script>
<!-- End BestNest Homepage.Js -->

<!-- Autocomplete Search Script -->
<script src="http://resources.bestnest.in/js/jquery.autocomplete.min.js" type="text/javascript"></script>
<!-- End Autocomplete Search Script -->

<style>
.hidefilter {display:none;}
.showfilter {display:block;}
.autocomplete-suggestions {border: 1px solid #999; background: #fff; cursor: default; overflow-y:scroll;}
.autocomplete-suggestions strong {font-weight: normal; color: #3399ff;}
.autocomplete-suggestion {padding: 10px 5px; font-size: 1.2em; white-space: nowrap;}
...
<!--Responsive Navigation-->
    ...
    <body>
        ...
        <script>
          (function() {
            var cx = '005943896007711797641:65mrvq5hmu8';

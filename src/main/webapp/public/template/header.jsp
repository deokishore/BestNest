...
<header>
  <div class="head">
    <div class="logo"> <a href="/" title="BestNest Real Estate Services Pvt. Ltd."><img src="http://images.bestnest.in/best-nest.png" alt="BestNest Real Estate Services Pvt. Ltd." /></a>
      <div class="clear"></div>
    </div>
    ...
    <ul class="nav">
        ...
        <li><a href="/posts" class="deactive" title="BestNest Blogs">Blogger</a></li>

...
@Controller
@RequestMapping(value="/shivalikhomes")
public class ShivalikHomesController {
	
	private static final Logger logger = LoggerFactory.getLogger(ShivalikHomesController.class);

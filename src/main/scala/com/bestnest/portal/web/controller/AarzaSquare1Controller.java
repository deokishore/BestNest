...
public class AarzaSquare1Controller {
	...
	public ModelAndView mahagunProject(HttpServletRequest request) {
		...
		return new ModelAndView("aarzasquare1");
 	}

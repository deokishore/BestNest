...
@Controller
@RequestMapping(value="/noida-residential-projects")
public class NoidaResidentialProjectsController {
	
	@Autowired
	ProjectSearchService projectSearchService;
	
	@RequestMapping(method = RequestMethod.GET)
	public ModelAndView noidaResidentialProject(@ModelAttribute("projectSearchForm") ProjectSearchForm projectSearchForm, 
			BindingResult result,HttpServletRequest request) {
		
		// City 
		CityForm cityForm = createCity(Constant.NOIDA);

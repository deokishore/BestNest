...
@Controller
@RequestMapping(value="/riseorganicghar")
public class RiseOrganicGharController {
	
	private static final Logger logger = LoggerFactory.getLogger(RiseOrganicGharController.class);
	...
	public ModelAndView about() {
		ModelAndView mv = new ModelAndView("riseorganicghar/about");
		return mv;
 	}
	
	@RequestMapping(value="/contact", method = RequestMethod.GET)
	public ModelAndView contact() {
		ModelAndView mv = new ModelAndView("riseorganicghar/contact");
		return mv;
 	}
	
	@RequestMapping(value="/siteVisit", method = RequestMethod.GET)
	public ModelAndView siteVisit() {
		ModelAndView mv = new ModelAndView("riseorganicghar/sitevisit");
		return mv;
 	}

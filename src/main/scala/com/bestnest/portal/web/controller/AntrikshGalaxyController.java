...
@Controller
@RequestMapping(value="/antrikshgalaxy")
public class AntrikshGalaxyController {
	
	private static final Logger logger = LoggerFactory.getLogger(AntrikshGalaxyController.class);

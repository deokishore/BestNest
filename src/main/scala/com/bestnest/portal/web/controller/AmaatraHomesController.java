...
@Controller
@RequestMapping(value="/amaatrahomes")
public class AmaatraHomesController {
	
	private static final Logger logger = LoggerFactory.getLogger(AmaatraHomesController.class);
	...
	public ModelAndView about() {
		ModelAndView mv = new ModelAndView("amaatrahomes/about");
		return mv;
 	}
	
	@RequestMapping(value="/contact", method = RequestMethod.GET)
	public ModelAndView contact() {
		ModelAndView mv = new ModelAndView("amaatrahomes/contact");
		return mv;
 	}
	
	@RequestMapping(value="/siteVisit", method = RequestMethod.GET)
	public ModelAndView siteVisit() {
		ModelAndView mv = new ModelAndView("amaatrahomes/sitevisit");
		return mv;
 	}
